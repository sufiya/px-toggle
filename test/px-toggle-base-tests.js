...
function runBaseTests() {
  px_toggle_1 = document.getElementById('px_toggle_1');

  suite('Base Automation Tests for px-toggle', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-toggle fixture is created', function() {
      assert.isTrue(document.getElementById('px_toggle_1') !== null);
    });
